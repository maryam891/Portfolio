...
const skills = [
  { label: 'Programming Language & Frameworks', items: 'React · TypeScript · JavaScript · HTML & CSS · UX/UI Design · Graphic design · Node.js/Express · SQL/SQLite · Vue.js · WordPress' },
